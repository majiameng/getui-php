...
use tinymeng\getui\GTClient;
use tinymeng\getui\request\push\GTCondition;
use tinymeng\getui\request\user\GTAliasRequest;
use tinymeng\getui\request\user\GTBadgeSetRequest;
use tinymeng\getui\request\user\GTCidAlias;
use tinymeng\getui\request\user\GTTagBatchSetRequest;
use tinymeng\getui\request\user\GTTagSetRequest;
use tinymeng\getui\request\user\GTUserQueryRequest;
